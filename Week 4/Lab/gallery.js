...
for (let i = 0; i <= 7; i++) {
  ...
  if (i === 0) {
    ...
    myDiv.innerHTML =
      '<div class="card card7" onClick="on()"><div class="border"><div id="overlay"><button class="closeBtn" onClick="dismiss(this)" >X</button><h1 id="infoBoxH1">DOO DOO DOO</h1><p id="textInfo">asjfklagsjlk;jgslasg;djkasgd</p></div><h2>Debby</h2><div class="icons"><i class="fa fa-instagram" aria-hidden="true"></i><i class="fa fa-facebook" aria-hidden="true"></i><p class="fa">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>' +
      "</div></div></div>";
  }
